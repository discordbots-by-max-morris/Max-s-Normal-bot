...
module.exports = class BotStatsCommand extends Command {
    ...
    async run(message) {
        ...
        const StatusEmbed = new RichEmbed()
            ...
            .addField("My Discord Invite Link", "[Discord Invite Link](https://discordapp.com/api/oauth2/authorize?client_id=551589154165620761&permissions=8&scope=bot)", true)
